...
//             // Load return/refund status for every order
//             await loadReturnRefundDetails(orderData);
//         } catch (error) {
...
//                 try {
//                     const returnRes = await getReturnsByOrder(
//                         order._id
//                     );

//                     const returnData =
//                         returnRes?.data?.returns ||
//                         returnRes?.data?.return ||
//                         returnRes?.returns ||
//                         returnRes?.data ||
//                         null;

//                     if (returnData) {
//                         returns[order._id] = Array.isArray(returnData)
//                             ? returnData[returnData.length - 1]
//                             : returnData;
//                     }
//                 } catch (error) {
//                     console.log(
//                         `No return found for order ${order._id}`
//                     );
//                 }

//                 try {
//                     const refundRes = await getOrderRefunds(
//                         order._id
//                     );

//                     const refundData =
//                         refundRes?.data?.refunds ||
//                         refundRes?.refunds ||
//                         refundRes?.data ||
//                         null;

//                     if (refundData) {
//                         refunds[order._id] = Array.isArray(refundData)
//                             ? refundData[refundData.length - 1]
//                             : refundData;
//                     }
//                 } catch (error) {
//                     console.log(
//                         `No refund found for order ${order._id}`
//                     );
//                 }
//             })
//         );
...
//             setReturnMessage(
//                 "Please select or enter a return reason."
//             );
//             return;
//         }
...
//         const returnData = returnDetails[order._id];
...
//         const refundData = refundDetails[order._id];
...
//     const getReturnButtonText = (order) => {
//         const status = getReturnStatus(order);

//         if (!status) {
//             return "↩️ Return Product";
//         }

//         return `↩️ Return: ${status}`;
//     };
...
//                                 <option value="Product is different from description">
...
//                                 <option value="Product not required">
